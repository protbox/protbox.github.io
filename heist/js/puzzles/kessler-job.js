CaseFiles.register({
    ...
    categories: [
        ...
        { id: "role", label: "Role", items: ["Wheelman", "Safecracker", "Inside Man", "Distraction"] },
        { id: "tool", label: "Tool", items: ["Forged Badge", "Cut Wire", "Duplicate Key", "Smoke Bomb"] }
    ],
    clues: [
    ...
    solution: {
        "Vivian": { role: "Safecracker", tool: "Duplicate Key" },
        "Marcus": { role: "Wheelman", tool: "Cut Wire" },
        "Dez": { role: "Inside Man", tool: "Forged Badge" },
        "Ruth": { role: "Distraction", tool: "Smoke Bomb" }
    },
