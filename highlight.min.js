...
keyword:["alias","and","begin", "let", "BEGIN","break","case","class","defined","do","else","elsif","end","END","ensure","for","if","in","module", "as", "next","not","or","redo","require","rescue","retry","return","then","undef","unless","until","when","while","yield","include","extend","prepend","public","private","protected","raise","throw","print"],
built_in:["proc","lambda", "each", "string?", "array?", "size?", "nil?", "numeric?", "digits?", "each_pair", "super", "attr_accessor", "attr_reader","attr_writer","define_method","private_constant","module_function"],
